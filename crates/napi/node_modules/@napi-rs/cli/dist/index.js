...
async function generateTypeDef(options) {
	...
	const processedTypeDefs = await Promise.all(typeDefFiles.map((file) => processTypeDef(join(options.typeDefDir, file.name), options.constEnum ?? true)));
